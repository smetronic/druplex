...
<!-- End of Main Navigation -->
  ...
  <?php if($page['top_content_left'] || $page['top_content_right'] || $breadcrumb_position !== "none") : ?>
    <div id="top-content-region">
      <div class="row wrapper">
        ...
        <div id="top-content-left-region" class="col-md-6 text-center-responsive">
        ...
        <div id="top-content-right-region" class="col-md-6 text-right text-center-responsive">
  ...
  <div id="main-content">
    ...
    <div class="row wrapper">
      ...
      <div id="contact-content-region" class="<?php print $content_class; ?>">
